...
import { Shield, Key, Download } from "react-bootstrap-icons";
...
const TFASettingsPage = () => {
	...
	return (
		<div className="py-3">
					...
					{!tfaStatus.tfaEnabled ? (
						...
						<div className="d-flex gap-2">
							...
							<Button 
								...
								onClick={() => {
									const passwordPrompt = prompt("Enter your password to regenerate backup codes:");
									if (passwordPrompt) {
			...
			{/* Setup Modal */}
			<Modal show={showSetupModal} onHide={() => setShowSetupModal(false)} centered>
					...
					{setupData && (
						<>
							...
							<Form.Group className="mb-3">
								<Form.Label>Enter verification code from your app:</Form.Label>
								<Form.Control
									type="text"
									placeholder="123456"
				...
				<Modal.Footer>
					...
					<Button 
						...
						disabled={loading || !verificationToken || verificationToken.length !== 6}
					>
...
import React, { useState, useEffect } from "react";
import { Container, Card, Form, Button, Alert, Modal, Row, Col } from "react-bootstrap";
import { Shield, Key, Download, ExclamationTriangle } from "react-bootstrap-icons";
import { useLoaderData } from "react-router-dom";
...
const TFASettingsPage = () => {
	...
	return (
		<div className="py-3">
			...
			{/* Setup Modal */}
			<Modal show={showSetupModal} onHide={() => setShowSetupModal(false)} centered size="lg">
				<Modal.Header closeButton>
					<Modal.Title>Setup Two-Factor Authentication</Modal.Title>
				</Modal.Header>
				<Modal.Body>
					{setupData && (
						<>
							<div className="text-center mb-4">
								...
								<p className="text-muted">Use an authenticator app like Google Authenticator, Authy, or Microsoft Authenticator</p>
							...
							<div className="mb-4">
								...
								<p className="text-muted">If you can't scan the QR code, enter this secret manually:</p>
			...
			<Modal show={showBackupCodesModal} onHide={() => setShowBackupCodesModal(false)} centered>
				...
				<Modal.Body>
					<Alert variant="warning">
						<ExclamationTriangle className="me-2" />
						<strong>Important:</strong> Save these backup codes in a secure place. Each code can only be used once to access your account if you lose your authenticator device.
					</Alert>
					<div className="mb-3">
						<Row>
							{backupCodes.map((code, index) => (
