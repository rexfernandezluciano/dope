...
const PrivacyPolicyPage = () => {
	useEffect(() => {
		updatePageMeta({
			...
			description:
				"Read DOPE Network's privacy policy to understand how we protect and handle your personal data.",
						...
						<Card.Body className="px-3 p-5">
							...
							<div className="mb-4">
								...
								<p className="text-muted">
									...
									when you create an account, update your profile, post content,
									or communicate with us. This may include your name, email
									address, profile information, and any content you choose to
									share.
								</p>
							</div>
							...
							<div className="mb-4">
								...
								<p className="text-muted">
									...
									personalize your experience and show you relevant content.
								</p>
							</div>
							...
							<div className="mb-4">
								...
								<p className="text-muted">
									...
									information. You may also request that we limit or stop
									processing your information. To exercise these rights, please
